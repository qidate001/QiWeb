...
const CHANGELOG_DATA = [
    {
        ...
        "content": [
            "更新了齐的网站的网络地址",
            "重写了CFT（常用普通功能工具）的清理图标缓存方法实现。更加适配Windows11",
            "修复了YtDlp工具自动重命名只会重命名.mp4文件的问题",
            "修复了YtDlp工具编辑高级下载过滤参数（--match-filters）格式错误导致难以生效的问题",
            "优化了YtDlpToolMatchFilters的使用体验，点击ListBox会自动将内容给到手动添加中",
            "优化了MatchFilters的实现，不再完全依赖IO这种蠢到家的实现方式，而是事件触发重载",
            "重构了整个YtDlp的代码实现，现在维护更简单!"
        ]
    },
    {
        "version": "v2.9.1.0",
